...
const dateFormattetr = new Intl.DateTimeFormat("en", { dateStyle: "medium" })
        ...
        <Section>
            <Row>
                ...
                <Column>
                    ...
                    <Text className="mt-0 mr-4">{dateFormattetr.format(order.createdAt)}</Text>
                </Column>
                <Column>
            ...
            <Row className="mt-8">
                ...
                <Column align="right">
                    <Button
                        ...
                        className="bg-black text-white px-6 py-4 rounded text-lg">Download</Button>
                </Column>
            </Row>
            <Row>
                <Column>
