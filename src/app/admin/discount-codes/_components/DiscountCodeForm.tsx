...
export function DiscountCodeForm({ products }: {
    ...
    return <form action={action} className="space-y-8">
        ...
        <div className="space-y-2 gap-8 flex items-baseline">
            <div className="space-y-2">
                ...
                <RadioGroup id="discountType" name="discountType" defaultValue={DiscountType.PERCENTAGE}>
                    <div className="flex gap-2 items-center">
                        <RadioGroupItem id="percentage" value={DiscountType.PERCENTAGE} />
                        <Label htmlFor="percentage">Percentage</Label>
                    </div>
                    <div className="flex gap-2 items-center">
                        <RadioGroupItem id="fixed" value={DiscountType.FIXED} />
