...
import { getDiscountAmount } from "@/lib/dicountCodeHelpers";
...
export function CheckoutForm({ product, discountCode }: CheckoutFormProps) {
    ...
    const isDiscounted = amount !== product.priceInCent
...
function Form({ priceInCent, discountCode, productId }: {
    priceInCent: number,
    discountCode?: {
        id: string,
        discountAmount: number,
        ...
        <Card>
            ...
            <CardFooter>
                ...
                >
                    {isLoading
                        ? "purchasing..."
                        : `Purchace -  ${formatCurrency(priceInCent / 100)}`}
                </Button>
            </CardFooter>
        </Card>
    </form>
